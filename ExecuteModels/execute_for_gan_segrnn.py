import torch
import pandas as pd
from models.GeneratorWithSegRNN import GeneratorWithSegRNN as Generator
from models.DiscriminatorWithSegRNN import DiscriminatorWithSegRNN as Discriminator
...
def execute_for_gan_segrnn(cfg):
